...
public class TitleArchiveUI : MonoBehaviour
{
   ...
   生成进度：❌待生成 / ✅已绑图。剧情中 t:"cg" 条目展示即自动解锁。 */
    ...
    /// <summary>显示调试页面（版本号点击 5 次触发）。</summary>
    ...
    {
        var page = new VisualElement { name = "page-debug" };
        page.style.display = DisplayStyle.None;
        contentScroll.Add(page);
        tabPages["debug"] = page;

        var header = new Label("调试面板");
        header.style.fontSize = 24;
        header.style.color = new Color(1f, 0.5f, 0.3f, 1f);
        header.style.unityFontDefinition = Fd();
        header.style.unityFontStyleAndWeight = FontStyle.Bold;
        ...
        achHeader.style.color = goldNormal;
        ...
        unlockAllBtn.style.width = 240;
        unlockAllBtn.style.height = 38;
        unlockAllBtn.style.fontSize = 17;
        unlockAllBtn.style.unityTextAlign = TextAnchor.MiddleCenter;
        unlockAllBtn.style.unityFontDefinition = Fd();
        unlockAllBtn.style.backgroundColor = new Color(0.2f, 0.4f, 0.2f, 0.6f);
        unlockAllBtn.style.color = new Color(0.6f, 1f, 0.6f, 1f);
        unlockAllBtn.style.marginBottom = 10;
        page.Add(unlockAllBtn);
        ...
        resetAllBtn.style.width = 240;
        resetAllBtn.style.height = 38;
        resetAllBtn.style.fontSize = 17;
        resetAllBtn.style.unityTextAlign = TextAnchor.MiddleCenter;
        resetAllBtn.style.unityFontDefinition = Fd();
        resetAllBtn.style.backgroundColor = new Color(0.4f, 0.2f, 0.2f, 0.6f);
        resetAllBtn.style.color = new Color(1f, 0.6f, 0.6f, 1f);
        resetAllBtn.style.marginBottom = 16;
        page.Add(resetAllBtn);
        ...
        for (int i = 0; i < allAch.Length; i++)
        {
            ...
            nameLabel.style.color = ach.unlocked ? new Color(0.5f, 1f, 0.5f, 1f) : grayText;
            ...
            statusLabel.style.color = ach.unlocked ? new Color(0.5f, 1f, 0.5f, 0.8f) : dimText;
            ...
            if (!ach.unlocked)
            {
                ...
                unlockBtn.style.width = 70;
                unlockBtn.style.height = 28;
                unlockBtn.style.fontSize = 14;
                unlockBtn.style.unityTextAlign = TextAnchor.MiddleCenter;
        ...
        // 返回主日志
        var backBtn = new Button(() => { ShowTab("achievements"); }) { text = "返回站长日志" };
        backBtn.style.width = 180;
        backBtn.style.height = 38;
        backBtn.style.fontSize = 17;
        backBtn.style.unityTextAlign = TextAnchor.MiddleCenter;
        backBtn.style.unityFontDefinition = Fd();
        backBtn.style.marginTop = 20;
        StylizeTab(backBtn);
        page.Add(backBtn);
    }
