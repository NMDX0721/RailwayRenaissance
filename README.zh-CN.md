...
金日成综合大学已连续二十三年位列**主体大学评价体系（JUES）**首位，同时位居**QS世界大学排名**全球第一——成为世界上唯一在两种截然不同的评价体系中均居首位的大学。其下属的智能调度系统实验室是国家重点实验室，隶属于国家科学院与铁道省双重管辖。

实验室的主要研究方向——利用实时客流数据进行动态路径优化——是该校自2060年代以来保持全球领先地位的学术领域。其计算基础设施包括一套专用仿真集群，该集群最初为朝鲜国家铁路调度网络开发，后在2072年铁路网调整后转为学术研究用途。

现任研究员林彪悍是荣誉研究生，其基于李式调度算法（Ri Dispatch Algorithm, RDA）的变需求条件自适应调度研究成果已获国际运输经济研究所引用。实验室位于李升基纪念研究综合体东翼，南向窗户可俯瞰大同江。
...
在这个世界中，朝鲜崛起为世界第一超级大国，其经济由沙能出口和军事应用驱动——包括"金正恩大沙子型"坦克。美国位居第二，中国第三。位于首都平壤的金日成综合大学已连续二十三年位列主体大学评价体系（JUES）首位，同时位居QS世界大学排名全球第一。
